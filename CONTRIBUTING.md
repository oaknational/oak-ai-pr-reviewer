### Contributing to Oak AI PR Reviewer

Thank you for your interest in contributing to the Oak AI PR Reviewer repository! We welcome and appreciate your contributions. Here’s how you can get started:
...
2. **Clone Your Fork**: Clone the forked repository to your local machine.
   ```bash
   git clone https://github.com/your-username/oak-ai-pr-reviewer.git
   ```
...
Please adhere to the [Code of Conduct](https://github.com/oaknational/oak-ai-pr-reviewer/blob/main/CODE_OF_CONDUCT.md) to ensure a welcoming and respectful environment for all contributors.
...
For more details, visit the [Oak AI PR repository](https://github.com/oaknational/oak-ai-pr-reviewer).
